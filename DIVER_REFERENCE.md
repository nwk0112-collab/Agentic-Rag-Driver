# DIVER research reference

> This is the retained upstream research documentation. References to “we” and “our” below refer to the original DIVER authors. Benchmark scores are published reference results, not independently reproduced results from this repository.
...
- [2025-09-12] 🚀 We released the code for listwise reranking using Gemini; it can be found at [./Retriever/rerank_listwise.py](Reranker/rerank_listwise.py), and it achieved a score of 43.9 on BRIGHT.
...
> Archived upstream commands. See the [current configuration notes](README.md#getting-started) before running; these commands require adaptation for this repository.
