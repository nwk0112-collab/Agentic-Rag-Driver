...
for task in "${tasks[@]}"; do
    ...
    # pointwise reranker
    CUDA_VISIBLE_DEVICES=0 python rerank_pointwise.py --task "$task" --retriever_score_file "output/merge_${REASONING}_bm25_${REASONING}_${MODEL}/${task}_bm25_${MODEL}/${task}_merge_score.json" --input_k 100 --k 100 --output_dir "output/reranker/merge_${REASONING}_bm25_${REASONING}_${MODEL}_point/${task}_merge_bm25_${MODEL}" --llm_model ${llm_model}
    # listwise reranker
