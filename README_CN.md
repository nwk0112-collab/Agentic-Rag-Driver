...
DIVER 是一个专为推理密集型信息检索量身定制的检索流程，它由四个组件构成：文档处理以提升输入质量、通过迭代文档交互由大语言模型驱动的查询扩展、在合成多领域数据（含难负样本）上进行推理增强的检索器微调，以及结合大语言模型分配的有用性得分与检索得分的点排序重排器。

## 🎉 更新列表

- [2025-08-24] 我们更新了Diver V2，在[Bright Leaderboard](https://brightbenchmark.github.io/)效果进一步提升至45.8。
- [2025-08-18] 🚀 我们开源了整体代码库包括推理和训练。
