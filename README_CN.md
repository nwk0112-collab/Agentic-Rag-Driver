...
- [2025-11-20] 🚀 我们发布了我们的重排模型 [Diver-GroupRank-7B](https://huggingface.co/AQ-MedAI/Diver-GroupRank-7B) 和 [Diver-GroupRank-32B](https://huggingface.co/AQ-MedAI/Diver-GroupRank-32B), 推理代码可在 [./Retriever/rerank_groupwise.py](./Retriever/rerank_groupwise.py) 找到. 我们的 GroupRank-32B 模型经过测试时增强后可在BRIGHT上达到46.8的分数，详见 [paper](https://www.arxiv.org/abs/2511.11653)。
